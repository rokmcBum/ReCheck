...
sealed class BottomNavItem(val route: String, val label: String, @DrawableRes val iconRes: Int) {
    ...
    object History  : BottomNavItem(Routes.History.route,  "히스토리",    R.drawable.baseline_history_24)
    object Share   : BottomNavItem(Routes.Share.route,   "공유",  R.drawable.baseline_share_24)
}
